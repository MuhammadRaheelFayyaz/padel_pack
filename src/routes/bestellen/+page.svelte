        ...
        onSuccess: async (props) => {  
            ...
            const order = {
              ...
              "payment_options": {
                  ...
                  "notification_url": "https://9d8a-2401-ba80-a10c-183-30bc-dc43-a752-bb4f.ngrok-free.app/api/webhooks/multisafepay",
    ...
    <div class="container">
      ...
      <div class="grid grid-cols-1 mb-8">
        <div class="relative flex justify-between gap-4">
          <div
            class="flex justify-center items-center border border-theme-dark-blue w-8 h-8 rounded-full bg-theme-dark-blue z-[1]"
          >
            <svg
              width="8"
              height="11"
          ...
          >
            ...
            >
              <path
                d="M11.9547 1.88636V1.27272C11.9547 0.569817 11.3849 0 10.682 0H1.59108C0.888176 0 0.318359 0.569817 0.318359 1.27272V1.88636C0.318359 1.94911 0.369246 1.99999 0.431995 1.99999H11.8411C11.9038 1.99999 11.9547 1.94911 11.9547 1.88636Z"
                fill="#012242"
              />
              <path
                d="M0.318359 2.84093V6.72728C0.318359 7.43019 0.888176 8.00001 1.59108 8.00001H10.682C11.3849 8.00001 11.9547 7.43019 11.9547 6.72728V2.84093C11.9547 2.77818 11.9038 2.72729 11.8411 2.72729H0.431995C0.369246 2.72729 0.318359 2.77818 0.318359 2.84093ZM3.22744 5.8182C3.22744 6.01901 3.06462 6.18183 2.86381 6.18183H2.50017C2.29935 6.18183 2.13654 6.01901 2.13654 5.8182V5.45456C2.13654 5.25374 2.29935 5.09092 2.50017 5.09092H2.86381C3.06462 5.09092 3.22744 5.25374 3.22744 5.45456V5.8182Z"
                fill="#012242"
              />
            </svg>
          </div>
            ...
            <div>
              ...
              >
                ...
                <div class="flex flex-col space-y-6 form--dark">
                  ...
                  <button
                    class="button button-success ml-auto"
          ...
          <aside class="flex flex-col gap-4">
            <div class="card--simple">
              <div class="card--simple__header">
                <h5>
                  Besteloverzicht <span class="text-xs"
                    >({$cart.items.length}) artikel</span
                  >
                </h5>
              </div>
                          ...
                          <tr class="text-right">
                            <td class="text-right w-6 pr-0 text-[#C8C8C8]">
                              <div class="relative">
                                ...
                                <span
                                  class="absolute top-2 left-0 w-14 h-px bg-black/30 -rotate-12"
                                />
                              </div>
                            </td>
                            {#if item.hasDiscount}
                      ...
                      <tr>
                        <td class="text-[10px] max-w-[181px] italic">
                          <p class="whitespace-wrap">
                            <strong class="text-green-lemon"
                              >Introductie deal:</strong
                            >
                            50% korting 1e <br />pakket, normaal tarief pakket 2
                            en 3
                          </p>
                        </td>
                        <td />
                      ...
                      <table class="text-xs">
                        <tr>
                          <td class="w-6 pr-0">
                            ...
                            <p class="text-green-lemon max-w-[70%]">
                              Bepaal zelf welke maanden je deze<br /> pakketten bezorgd
                              krijgt!
                            </p>
                          </td>
            ...
            <div class="card--simple">
              ...
              <div class="card--simple__body text-[#C8C8C8]">
                ...
                <p class="text-xs">
                  Levering naar Nederland/België binnen 5 werkdagen
                </p>
              </div>
            </div>
            <div class="card--simple">
                    ...
                    <defs>
                      ...
                      <clipPath id="clip1_159_515">
                        <rect
                          ...
                          height="19.3409"
                          fill="white"
                          transform="translate(192 20.6592)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
